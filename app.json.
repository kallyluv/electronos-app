{
  ...
  //optional additives (these are default values)
  "width": "100px", //window width when opening. no lower than 100px is accepted
  "height": "50px", //window height when opening. no lower than 50px is accepted
